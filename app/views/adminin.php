...
<head>
  ...
  <meta http-equiv="Pragma" content="no-cache">
    ...
    <link rel="stylesheet" href="../../public/css/adminin.css?v=<?php echo(rand()); ?>" />
...
<body>
    ...
    <nav class="nav2">
        ...
        <a href="#" class="fotoperfilnav" id="btnperfil" > <div id="photonav"><img src="../../public/img/logo.png" alt=""></a>
                ...
                <li><a class="bloqueo"  href="almacen.php"><img src="../../public/img/producto.png" alt="">Crear producto</a></li>
